...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-[1360px] mx-auto w-full border-4 border-[#1e2235] p-2 md:p-4 bg-[#030509]/90 rounded-[30px] shadow-2xl"
    >
      <div className="h-full w-full overflow-hidden rounded-2xl bg-[#020306]/85 md:rounded-2xl p-1 md:p-2 border border-white/5">
        {children}
      </div>
    </motion.div>
  );
